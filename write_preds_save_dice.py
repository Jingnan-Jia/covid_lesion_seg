...
""","""
task = 'vessel'
biggest_5_lobe = False
for sub_dir in ["Covid_lesion"]:
    str_names = [
        "1604711826_905"
        # "1600478665_586_lrlb0.0001lrvs1e-05mtscale0netnolpm0.0nldLUNA16ao0ds0pps100lbnb17vsnb50nlnb400ptsz144ptzsz96",
        # "1600479252_70_lrlb0.0001lrvs1e-05mtscale1netnolpm0.0nldLUNA16ao0ds0pps100lbnb17vsnb50nlnb400ptsz144ptzsz96",
    ...
    for str_name in str_names:
        ...
        tr_sp, tr_z_sp = 0.77, 5
        tr_sz, tr_z_sz = None, None
        pt_sz, pt_z_sz = 256, 16
        pad = 0
        ...
        for goal in goals:
            ...
            if fissure:
                gntFissure(mypath.pred_path("valid", sub_dir=sub_dir, cntd_pts=biggest_5_lobe), radiusValue=radiusValue, workers=10)
            else:
                ...
                write_preds_to_disk(segment=segment,
                                    ...
                                    number=None,
                                    stride=stride, workers=workers, qsize=20, pad=pad)
                if biggest_5_lobe:
                    write_cntd_pts(mypath.pred_path("valid", sub_dir=sub_dir), workers=5,
                                   target_dir=mypath.pred_path("valid", sub_dir=sub_dir, cntd_pts=biggest_5_lobe))
            ...
            write_all_metrics(labels=labels,  # exclude background
                              ...
                              pred_path=mypath.pred_path("valid", sub_dir=sub_dir, cntd_pts=biggest_5_lobe),
