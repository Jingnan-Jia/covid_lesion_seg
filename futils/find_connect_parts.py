...
def write_cntd_pts(pred_file_dir, workers=10, target_dir=None):
    scan_files = cu.get_all_ct_names(pred_file_dir)
    ...
    cu.execute_the_function_multi_thread(consumer=write_connected_lobe, workers=workers)
...
def main():
    ...
    for pred_file_dir in pred_file_dirs:
        write_cntd_pts(pred_file_dir, workers=10)
    print('finish')
